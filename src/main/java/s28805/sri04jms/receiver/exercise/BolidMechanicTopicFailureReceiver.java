...
@Component public class BolidMechanicTopicFailureReceiver {
    @JmsListener(destination = BolidJmsConfig.TOPIC_FAILURE, containerFactory = "bolidTopicConnectionFactory")
    public void receiveHelloMessage(@Payload BolidCommunication convertedMessage,
                                    @Headers MessageHeaders messageHeaders,
                                    Message message) {
        System.out.println("Mechanic, message: "+convertedMessage);
    }
}